...
use hvergelmir::{WorkspaceError, WorkspaceProvider};
use mimisbrunnr::{
    MemoryBackend, MemoryError, MemoryQuery, MemoryScope, MemoryTier, SearchHit, StoreMemory,
};
use serde::{Deserialize, Serialize};
use serde_json::json;
use thingr::{ClaimRequest, Task, TaskError, TaskStatus, TaskStore, TransitionTask, VerifierGate};
use tokio::time;
        ...
        for task in eligible {
            ...
            let Some(task) = self
                ...
                .claim(ClaimRequest {
                    ...
                    claimant: "urdarbrunnr-worker".to_string(),
                })
                .await?
            else {
                continue;
