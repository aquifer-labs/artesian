...
pub enum MemoryError {
    ...
    #[error(
        "collection embedding metadata mismatch: collection={collection_model}/{collection_dimensions}, configured={configured_model}/{configured_dimensions}; run artesian migrate before reading or writing"
    )]
    CompatMismatch {
